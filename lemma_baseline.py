...
parser.add_argument('--input_file', type=str, default='data/all_mentions.json')
...
if __name__ == '__main__':
    ...
    event_mentions['mention_lemma'] = [[token.lemma_ for token in nlp(mention['text'])] for i, mention in event_mentions.iterrows()]
    ...
    exact_string = [mention['text'] for i, mention in  event_mentions.iterrows()]
